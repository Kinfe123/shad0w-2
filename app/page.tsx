    ...
    <div className="w-full flex justify-center items-center">
      <ScrollProvider>
        <section className="w-full flex flex-col justify-center items-center gap-6 pb-8 md:pb-10 ">
          ...
          <div className="hidden lg:block w-full overflow-x-hidden md:overflow-x-clip ">
            <HappyRect />
          </div>
          ...
          <div className="hidden md:grid grid-cols-2 gap-1">
            <div className="mt-[-500x] flex  items-center justify-center bg-transparent px-10">
              <p className="d:text-4xl mt-[-700px] bg-gradient-to-tr from-[#E0B379] to-[#e8eaed] bg-clip-text font-heading2 font-medium text-transparent lg:text-[9.5rem] sticky top-20 ">
