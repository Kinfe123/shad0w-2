...
export default function Intro() {
  ...
  return (
    <div
      ...
      id="intro"
    >
      <div className="mx-auto flex min-h-screen max-w-screen overflow-hidden flex-col items-center justify-center  px-10 py-24 text-5xl font-semibold tracking-tight md:py-28 md:text-6xl lg:px-20 lg:py-3 lg:text-[10rem]">
