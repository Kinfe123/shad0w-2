          ...
          <div className="h-screen lg:h-auto mx-auto max-w-6xl  pt-44 lg:py-40">
            ...
            <div className="w-full md:flex md:flex-col md:justify-start md:items-start">
              ...
              >
                ...
                <br />
                <span className="font-heading2 text-center bg-gradient-to-tr from-[#E0B379] to-[#e8eaed] bg-clip-text text-transparent mt-[-3.8rem] lg:mt-[-6.5rem]">
                  IDEA &nbsp; TO
                </span>
                <span className="font-heading2 text-center bg-gradient-to-tr from-[#E0B379] to-[#e8eaed] bg-clip-text text-transparent mt-[-1rem] sm:mt-0">
                  P R O D U C T.
                </span>
                {/* <span className={cn(styles.magicText)}>SHADOW VENTURES</span>{" "}
                <br />
