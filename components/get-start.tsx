...
const GetStarted = () => {
  return (
    <div>
      <form className="relative mx-auto  flex  h-56 w-full max-w-6xl flex-col items-center justify-center space-y-5 overflow-hidden rounded-full border   border-neutral-500 bg-gradient-to-tr from-transparent to-transparent/90 p-3 px-10  py-10 text-neutral-800">
        <div className="before:absolute before:w-32 before:h-20 before:right-2 before:bg-rose-300 before:-z-10 before:rounded-full before:blur-xl before:-top-12   z-10 after:absolute after:w-24 after:h-24 after:bg-purple-300 after:-z-10 after:rounded-full after:blur after:-top-12 after:-right-6">
          <span className="uppercase font-extrabold flex justify-center items-center text-center text-4xl font-heading2 bg-gradient-to-tr from-[#E0B379] to-[#e8eaed] bg-clip-text text-transparent">
            Get more updates
          </span>
        ...
        <div className="flex gap-1">
          <div className="relative rounded-lg w-80 overflow-hidden  before:absolute before:w-12 before:h-12 before:content[''] before:right-0 before:bg-violet-500 before:rounded-full before:blur-lg  after:absolute after:z-10 after:w-20 after:h-20 after:content['']  after:bg-rose-300 after:right-12 after:top-3 after:rounded-full after:blur-lg">
            <input
              placeholder="xyz@arezarmada.com"
